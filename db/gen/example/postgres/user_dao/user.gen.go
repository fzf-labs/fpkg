...
func newUser(db *gorm.DB, opts ...gen.DOOption) user {
	...
	_user.userDo.UseModel(&user_model.User{})
...
func (u userDo) Create(values ...*user_model.User) error {
	if len(values) == 0 {
		return nil
	}
...
func (u userDo) CreateInBatches(values []*user_model.User, batchSize int) error {
	return u.DO.CreateInBatches(values, batchSize)
}

// Save : !!! underlying implementation is different with GORM
// The method is equivalent to executing the statement: db.Clauses(clause.OnConflict{UpdateAll: true}).Create(values)
func (u userDo) Save(values ...*user_model.User) error {
	if len(values) == 0 {
		return nil
	}
...
func (u userDo) First() (*user_model.User, error) {
	if result, err := u.DO.First(); err != nil {
		return nil, err
	} else {
		return result.(*user_model.User), nil
	}
}

func (u userDo) Take() (*user_model.User, error) {
...
func (u userDo) Last() (*user_model.User, error) {
...
func (u userDo) Find() ([]*user_model.User, error) {
	result, err := u.DO.Find()
	return result.([]*user_model.User), err
}

func (u userDo) FindInBatch(batchSize int, fc func(tx gen.Dao, batch int) error) (results []*user_model.User, err error) {
	buf := make([]*user_model.User, 0, batchSize)
...
func (u userDo) FindInBatches(result *[]*user_model.User, batchSize int, fc func(tx gen.Dao, batch int) error) error {
...
func (u userDo) FirstOrInit() (*user_model.User, error) {
...
func (u userDo) FirstOrCreate() (*user_model.User, error) {
...
func (u userDo) FindByPage(offset int, limit int) (result []*user_model.User, count int64, err error) {
...
func (u userDo) Delete(models ...*user_model.User) (result gen.ResultInfo, err error) {
