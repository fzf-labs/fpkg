...
func newSysDict(db *gorm.DB, opts ...gen.DOOption) sysDict {
	...
	_sysDict.sysDictDo.UseModel(&gorm_gen_model.SysDict{})
...
func (s sysDictDo) Create(values ...*gorm_gen_model.SysDict) error {
	if len(values) == 0 {
		return nil
	}
...
func (s sysDictDo) CreateInBatches(values []*gorm_gen_model.SysDict, batchSize int) error {
	return s.DO.CreateInBatches(values, batchSize)
}

// Save : !!! underlying implementation is different with GORM
// The method is equivalent to executing the statement: db.Clauses(clause.OnConflict{UpdateAll: true}).Create(values)
func (s sysDictDo) Save(values ...*gorm_gen_model.SysDict) error {
	if len(values) == 0 {
		return nil
	}
...
func (s sysDictDo) First() (*gorm_gen_model.SysDict, error) {
	if result, err := s.DO.First(); err != nil {
		return nil, err
	} else {
		return result.(*gorm_gen_model.SysDict), nil
	}
}

func (s sysDictDo) Take() (*gorm_gen_model.SysDict, error) {
...
func (s sysDictDo) Last() (*gorm_gen_model.SysDict, error) {
...
func (s sysDictDo) Find() ([]*gorm_gen_model.SysDict, error) {
	result, err := s.DO.Find()
	return result.([]*gorm_gen_model.SysDict), err
}

func (s sysDictDo) FindInBatch(batchSize int, fc func(tx gen.Dao, batch int) error) (results []*gorm_gen_model.SysDict, err error) {
	buf := make([]*gorm_gen_model.SysDict, 0, batchSize)
...
func (s sysDictDo) FindInBatches(result *[]*gorm_gen_model.SysDict, batchSize int, fc func(tx gen.Dao, batch int) error) error {
...
func (s sysDictDo) FirstOrInit() (*gorm_gen_model.SysDict, error) {
...
func (s sysDictDo) FirstOrCreate() (*gorm_gen_model.SysDict, error) {
...
func (s sysDictDo) FindByPage(offset int, limit int) (result []*gorm_gen_model.SysDict, count int64, err error) {
...
func (s sysDictDo) Delete(models ...*gorm_gen_model.SysDict) (result gen.ResultInfo, err error) {
