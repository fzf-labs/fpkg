...
func newSysLog(db *gorm.DB, opts ...gen.DOOption) sysLog {
	...
	_sysLog.sysLogDo.UseModel(&gorm_gen_model.SysLog{})
...
func (s sysLogDo) Create(values ...*gorm_gen_model.SysLog) error {
	if len(values) == 0 {
		return nil
	}
...
func (s sysLogDo) CreateInBatches(values []*gorm_gen_model.SysLog, batchSize int) error {
	return s.DO.CreateInBatches(values, batchSize)
}

// Save : !!! underlying implementation is different with GORM
// The method is equivalent to executing the statement: db.Clauses(clause.OnConflict{UpdateAll: true}).Create(values)
func (s sysLogDo) Save(values ...*gorm_gen_model.SysLog) error {
	if len(values) == 0 {
		return nil
	}
...
func (s sysLogDo) First() (*gorm_gen_model.SysLog, error) {
	if result, err := s.DO.First(); err != nil {
		return nil, err
	} else {
		return result.(*gorm_gen_model.SysLog), nil
	}
}

func (s sysLogDo) Take() (*gorm_gen_model.SysLog, error) {
...
func (s sysLogDo) Last() (*gorm_gen_model.SysLog, error) {
...
func (s sysLogDo) Find() ([]*gorm_gen_model.SysLog, error) {
	result, err := s.DO.Find()
	return result.([]*gorm_gen_model.SysLog), err
}

func (s sysLogDo) FindInBatch(batchSize int, fc func(tx gen.Dao, batch int) error) (results []*gorm_gen_model.SysLog, err error) {
	buf := make([]*gorm_gen_model.SysLog, 0, batchSize)
...
func (s sysLogDo) FindInBatches(result *[]*gorm_gen_model.SysLog, batchSize int, fc func(tx gen.Dao, batch int) error) error {
...
func (s sysLogDo) FirstOrInit() (*gorm_gen_model.SysLog, error) {
...
func (s sysLogDo) FirstOrCreate() (*gorm_gen_model.SysLog, error) {
...
func (s sysLogDo) FindByPage(offset int, limit int) (result []*gorm_gen_model.SysLog, count int64, err error) {
...
func (s sysLogDo) Delete(models ...*gorm_gen_model.SysLog) (result gen.ResultInfo, err error) {
