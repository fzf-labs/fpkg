...
func newSysAdmin(db *gorm.DB, opts ...gen.DOOption) sysAdmin {
	...
	_sysAdmin.sysAdminDo.UseModel(&gorm_gen_model.SysAdmin{})
...
func (s sysAdminDo) Create(values ...*gorm_gen_model.SysAdmin) error {
	if len(values) == 0 {
		return nil
	}
...
func (s sysAdminDo) CreateInBatches(values []*gorm_gen_model.SysAdmin, batchSize int) error {
	return s.DO.CreateInBatches(values, batchSize)
}

// Save : !!! underlying implementation is different with GORM
// The method is equivalent to executing the statement: db.Clauses(clause.OnConflict{UpdateAll: true}).Create(values)
func (s sysAdminDo) Save(values ...*gorm_gen_model.SysAdmin) error {
	if len(values) == 0 {
		return nil
	}
...
func (s sysAdminDo) First() (*gorm_gen_model.SysAdmin, error) {
	if result, err := s.DO.First(); err != nil {
		return nil, err
	} else {
		return result.(*gorm_gen_model.SysAdmin), nil
	}
}

func (s sysAdminDo) Take() (*gorm_gen_model.SysAdmin, error) {
...
func (s sysAdminDo) Last() (*gorm_gen_model.SysAdmin, error) {
...
func (s sysAdminDo) Find() ([]*gorm_gen_model.SysAdmin, error) {
	result, err := s.DO.Find()
	return result.([]*gorm_gen_model.SysAdmin), err
}

func (s sysAdminDo) FindInBatch(batchSize int, fc func(tx gen.Dao, batch int) error) (results []*gorm_gen_model.SysAdmin, err error) {
	buf := make([]*gorm_gen_model.SysAdmin, 0, batchSize)
...
func (s sysAdminDo) FindInBatches(result *[]*gorm_gen_model.SysAdmin, batchSize int, fc func(tx gen.Dao, batch int) error) error {
...
func (s sysAdminDo) FirstOrInit() (*gorm_gen_model.SysAdmin, error) {
...
func (s sysAdminDo) FirstOrCreate() (*gorm_gen_model.SysAdmin, error) {
...
func (s sysAdminDo) FindByPage(offset int, limit int) (result []*gorm_gen_model.SysAdmin, count int64, err error) {
...
func (s sysAdminDo) Delete(models ...*gorm_gen_model.SysAdmin) (result gen.ResultInfo, err error) {
