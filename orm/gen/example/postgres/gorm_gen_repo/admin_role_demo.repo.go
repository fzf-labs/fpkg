...
type (
	IAdminRoleDemoRepo interface {
		...
		FindMultiByCustom(ctx context.Context, customReq *custom.PaginatorReq) ([]*gorm_gen_model.AdminRoleDemo, *custom.PaginatorReply, error)
...
// FindMultiByCustom 自定义查询数据(通用)
func (a *AdminRoleDemoRepo) FindMultiByCustom(ctx context.Context, customReq *custom.PaginatorReq) ([]*gorm_gen_model.AdminRoleDemo, *custom.PaginatorReply, error) {
