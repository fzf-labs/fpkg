...
type (
	IAdminRoleDemoRepo interface {
		...
		FindMultiByPaginator(ctx context.Context, paginatorReq *paginator.PaginatorReq) ([]*gorm_gen_model.AdminRoleDemo, *paginator.PaginatorReply, error)
...
// FindMultiByPaginator 查询分页数据(通用)
func (a *AdminRoleDemoRepo) FindMultiByPaginator(ctx context.Context, paginatorReq *paginator.PaginatorReq) ([]*gorm_gen_model.AdminRoleDemo, *paginator.PaginatorReply, error) {
