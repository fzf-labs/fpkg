...
type (
	IAdminLogDemoRepo interface {
		...
		FindMultiByPaginator(ctx context.Context, paginatorReq *paginator.Req) ([]*gorm_gen_model.AdminLogDemo, *paginator.Reply, error)
...
// FindMultiByPaginator 查询分页数据(通用)
func (a *AdminLogDemoRepo) FindMultiByPaginator(ctx context.Context, paginatorReq *paginator.Req) ([]*gorm_gen_model.AdminLogDemo, *paginator.Reply, error) {
